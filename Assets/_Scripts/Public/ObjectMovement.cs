...
public class ObjectMovement : MonoBehaviour {
    ...
    /// <summary>
    /// Velocity를 0으로 초기화 시켜주는 함수
    /// </summary>
    public void InitVelocity(Rigidbody selfRigidbody)
    {
        Vector3 init = new Vector3(0, 0, 0);
        selfRigidbody.velocity = init;
    }
    public void InitVelocity(Rigidbody2D selfRigidbody)
    {
    ...
    /// </summary>
    public Vector3 MovePos(Rigidbody rb, Vector3 distanceToMove, float speed = 1)
    {
    ...
    /// </summary>
    public Vector3 Move(Rigidbody rb, Vector3 distanceToMove, float speed = 1) {
    ...
    //목적지까지 가는 함수
    public IEnumerator MoveToDestination(Rigidbody2D rb, Vector2 destination, float speed = 1f, float accelation = 0)
    {
    ...
    public void Turn(Rigidbody rb, Vector3 moveRotation, float rotationSpeed = 1f)
    {
    ...
    /// velocity를 이용한 점프함수
    /// </summary>
    public void Jump(Rigidbody rb, float jumpHeight = 1f)
    {
        Vector3 origin;
